...
public class Restaurant2 extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter= new ArrayAdapter<String>(Restaurant2.this,
        ...
        ArrayAdapter<String> myAdapter2= new ArrayAdapter<String>(Restaurant2.this,
        ...
        ArrayAdapter<String> myAdapter3= new ArrayAdapter<String>(Restaurant2.this,
