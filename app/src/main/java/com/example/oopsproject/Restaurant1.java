...
public class Restaurant1 extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter= new ArrayAdapter<String>(Restaurant1.this,
        ...
        ArrayAdapter<String> myAdapter2= new ArrayAdapter<String>(Restaurant1.this,
        ...
        ArrayAdapter<String> myAdapter3= new ArrayAdapter<String>(Restaurant1.this,
