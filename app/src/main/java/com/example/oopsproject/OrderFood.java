...
public class OrderFood extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter= new ArrayAdapter<String>(OrderFood.this,
        ...
        ArrayAdapter<String> myAdapter2= new ArrayAdapter<String>(OrderFood.this,
        ...
        ArrayAdapter<String> myAdapter3= new ArrayAdapter<String>(OrderFood.this,
